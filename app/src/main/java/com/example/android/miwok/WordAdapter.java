...
public class WordAdapter extends ArrayAdapter<WordClass>  {
    ...
    public WordAdapter(Context context, ArrayList<WordClass> words,int ColorResource) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Get the {@link WordClass} object located at this position in the list
...
//        int color = ContextCompat.getColor(getContext(), mColorResource);
        ...
        textContainer.setBackgroundResource(mColorResource);
